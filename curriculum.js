  ...
  lessons: [
    {
      ...
      url: "https://ocw.mit.edu/courses/esd-260j-logistics-systems-fall-2006/resources/lect5/",
      duration: "20–25 min",
      mode: "Focused Study",
      description: "Build defensible market and volume assumptions; focus on the new-product forecasting slides and where uncertainty enters the estimate."
    },
    {
    ...
    },
    {
      ...
      url: "https://ocw.mit.edu/courses/15-401-finance-theory-i-fall-2008/pages/video-lectures-and-slides/capital-budgeting/",
      duration: "~45 min",
      mode: "Watch",
      description: "Use incremental project cash flows and the NPV rule to decide whether a development or launch investment creates value."
    },
    {
      ...
      duration: "~45 min",
      mode: "Watch",
      description: "Compare NPV with IRR, profitability index, and capital rationing—and learn where shortcut metrics can mislead."
    },
    {
      ...
      source: "MIT OpenCourseWare",
      url: "https://ocw.mit.edu/courses/esd-70j-engineering-economy-module-fall-2009/pages/syllabus/",
      duration: "25–35 min",
      mode: "Focused Study",
      description: "See how one- and two-way sensitivity tables reveal the volume, price, variable-cost, CAPEX, and discount-rate assumptions that drive the recommendation."
    },
    {
      id: "bc-risk-decision",
      track: "business",
    ...
    },
    {
      ...
      mode: "Focused Study",
      description: "Select the surfactant, bubble, and Marangoni notes for a deeper physical picture of interfacial-tension gradients and film response."
    },
    {
